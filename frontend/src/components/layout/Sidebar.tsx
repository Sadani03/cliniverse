    ...
    <aside className="glass-panel-strong flex min-h-[calc(100vh-32px)] w-[260px] flex-col rounded-[30px] p-5">
      <div className="flex items-center gap-3 px-2 py-4">
        ...
        <div>
          ...
          >
            Clini<span className="text-gradient">Verse</span>
          </h1>
            ...
            <button
              ...
              className={cn(
                ...
                isActive
                  ...
                  : "text-[#521C0D]/75 hover:bg-white/35 hover:text-[#D5451B]"
              )}
            >
              <Icon size={20} />
      ...
      <div className="glass-panel mb-4 rounded-2xl p-4">
        ...
        <p className="mt-2 text-xs leading-5 text-[#85675E]">
          Nova is ready to support your health and
          well-being.
        </p>
      </div>
      ...
      <button
        type="button"
        className="flex items-center gap-3 rounded-2xl px-4 py-3.5 text-sm font-semibold text-[#D5451B] transition hover:bg-[#D5451B]/10"
      >
        <LogOut size={20} />
        Logout
      </button>
